...
from controller_functions import home, register, login, dashboard, myaccount, setdefaultpic, changedefaultpic, editaccount, addadog, delete_a_dog, viewdog, add_walk, see_view_walk_page, cancel_walk, leave_walk, join_walk, logout, editdog
