...
from controller_functions import home, register, login, dashboard, myaccount, addadog, viewdog, add_walk, see_view_walk_page, cancel_walk, leave_walk, join_walk, logout
...
app.add_url_rule("/dashboard/walk/<id>", view_func=see_view_walk_page, methods=["GET", "POST"])
